	...
	<?php if(isset($news_info)) { ?>
		<div class="content-news">
			...
			<!-- AddThis Button BEGIN -->
				<div class="addthis_toolbox addthis_pollishop_style ">
		...
		<?php foreach ($news_data as $news) { ?>
			<div class="panelcollapsed">
				...
				<div class="panelcontent">
					...
					<a href="<?php echo $news['href']; ?>"><img src="catalog/view/theme/pollishop2/image/message-news.png" alt="" /></a> <b><?php echo $text_posted; ?></b><?php echo $news['posted']; ?>
				</div>
			</div>
		<?php } ?>
		<div class="buttons">
