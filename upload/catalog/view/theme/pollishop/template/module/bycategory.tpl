<div class="box bycategory"> 
  
<div id="slider_vert" class="categ">
  ...
  <div  class="viewport">
    ...
    <ul class="overview">
      ...
      <li>
        ...
        <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo utf8_substr(strip_tags(html_entity_decode($product['name'])), 0, 30)."..." ?></a></div>
...
$(document).ready(function(){
            ...
            intervaltime: 24000, // interval time in milliseconds.
