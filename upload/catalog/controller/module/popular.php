...
class ControllerModulepopular extends Controller {
	protected function index($setting) {
		...
		$this->document->addScript('catalog/view/theme/' . $this->config->get('config_template') . '/js/jquery.sliderkit.1.4.js');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/popular.tpl')) {
			...
			$this->template = 'pollishop/template/module/popular.tpl';
		}
