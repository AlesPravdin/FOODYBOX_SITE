...
<td class="right">Youtube Video<br><img src="/admin/view/image/video_in_product.jpg"></td>
...
<td class="right"><input type="text" name="product_image[<?php echo $image_row; ?>][video_in_product]" value="<?php echo $product_image['video_in_product']; ?>" placeholder="<?php echo $entry_video_in_product; ?>" size="20" /></td>
...
html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][video_in_product]" value="" placeholder="<?php echo $entry_video_in_product; ?>" size="20" /></td>';
