...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/pollishop/stylesheet/news.css" />
...
if($this->config->get('pollishop_status')== 1) {

	if($this->config->get('pollishop_title_font')!='' || $this->config->get('pollishop_body_font')!='') {
		
		$regfonts = array('Arial', 'Verdana', 'Helvetica', 'Lucida Grande', 'Trebuchet MS', 'Times New Roman', 'Tahoma', 'Georgia' );
		
		// Titles font
		if (in_array($this->config->get('pollishop_title_font'), $regfonts)==false) { 
			?><link href='//fonts.googleapis.com/css?family=<?php echo $this->config->get('pollishop_title_font') ?>&v1' rel='stylesheet' type='text/css'><?php 
		} // Body font
		if (in_array($this->config->get('pollishop_body_font'), $regfonts)==false) { 
			?><link href='//fonts.googleapis.com/css?family=<?php echo $this->config->get('pollishop_body_font') ?>&v1' rel='stylesheet' type='text/css'><?php 
		}  
	} 
?>
	...
	<style type="text/css">
		...
		body{
			<?php if($this->config->get('pollishop_backgr_color')!='') { ?>
				background-color: <?php echo $this->config->get('pollishop_backgr_color'); ?>;
			<?php } 
           if (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') $path_image = $this->config->get('config_url');
			else $path_image = $this->config->get('config_url');
			
			if($this->config->get('pollishop_custom_pattern')!='') { ?>
			
			background-image: url("<?php echo $path_image .'image/' . $this->config->get('pollishop_custom_pattern') ?>"); ?>;
			
           <?php } else if($this->config->get('pollishop_pattern_overlay')!='none') { ?>
				background-image: url("catalog/view/theme/pollishop/image/patterns/overlay<?php echo $this->config->get('pollishop_pattern_overlay'); ?>.png");
			<?php } else { ?>
		   ...
		   <?php 
			if($this->config->get('pollishop_menubar_color')!='') { ?>
			#headermenu, #powered, .menuResp > li, .menuResp, .menuResp >li > div a:hover{
				background-color: <?php echo $this->config->get('pollishop_menubar_color'); ?>;
			}
			.htabs a.selected {border-top-color: <?php echo $this->config->get('pollishop_menubar_color'); ?>;
			}
			<?php } 
			
          if($this->config->get('pollishop_menulink_color')!='') { ?>
			#wrapper_menu .menu li.fullwidth > a {
				color: <?php echo $this->config->get('pollishop_menulink_color'); ?>;
			}				
		<?php }
		if($this->config->get('pollishop_hover_color')!='') { ?>
			#wrapper_menu .menu li.fullwidth > a :hover{
				color: <?php echo $this->config->get('pollishop_hover_color'); ?>;
			}				
		<?php }	
		 if($this->config->get('pollishop_menulink2_color')!='') { ?>
			#wrapper_menu .menu  .col_1 > div a, #wrapper_menu .menu  .col_1 > div  {
				color: <?php echo $this->config->get('pollishop_menulink2_color'); ?>;
			}				
		<?php }
		if($this->config->get('pollishop_hover2_color')!='') { ?>
			#wrapper_menu .menu  .col_1 > div a:hover{
				color: <?php echo $this->config->get('pollishop_hover2_color'); ?>;
			}				
		<?php }	
		 if($this->config->get('pollishop_menulink3_color')!='') { ?>
			#wrapper_menu .menu .col_1 ul li a {
				color: <?php echo $this->config->get('pollishop_menulink3_color'); ?>;
			}				
		<?php }
		if($this->config->get('pollishop_hover3_color')!='') { ?>
			#wrapper_menu .menu .col_1 ul li a:hover{
				color: <?php echo $this->config->get('pollishop_hover3_color'); ?>;
			}				
		<?php }	
			if($this->config->get('pollishop_multicolorbutton1')!='') { ?>
			#wrapper_menu .multicolor1, #mobile-menu{
				background-color: <?php echo $this->config->get('pollishop_multicolorbutton1'); ?>;
			}				
		<?php }
		if($this->config->get('pollishop_multicolorbutton2')!='') { ?>
			#wrapper_menu .multicolor2{
				background-color: <?php echo $this->config->get('pollishop_multicolorbutton2'); ?>;
			}				
		<?php }
		if($this->config->get('pollishop_multicolorbutton3')!='') { ?>
			#wrapper_menu .multicolor3{
				background-color: <?php echo $this->config->get('pollishop_multicolorbutton3'); ?>;
			}				
		<?php }
		
		if($this->config->get('pollishop_categ_color')!='') { ?>
			.box-category a {
				color: <?php echo $this->config->get('pollishop_categ_color'); ?>;
			}				
			
		<?php }	
		if($this->config->get('pollishop_hovercateg_color')!='') { ?>
			.box-category a:hover, .box-category > ul > li a.active, .box-category > ul > li a.active2  {
				color: <?php echo $this->config->get('pollishop_hovercateg_color'); ?>;
			}				
			
		<?php }	
			if($this->config->get('pollishop_activline_color')!='') { ?>
			.box-category li li:hover {
				background-color: <?php echo $this->config->get('pollishop_activline_color'); ?>;
			}	
		<?php }		
		
		if($this->config->get('pollishop_footertitle_color')!='') { ?>
			#footer h3 {
				color: <?php echo $this->config->get('pollishop_footertitle_color'); ?>;
			}				
			
		<?php }		
		if($this->config->get('pollishop_footer_color')!='') { ?>
			#footer .column a, #footer .tweetcolumn a, #footer .contact-column a  {
				color: <?php echo $this->config->get('pollishop_footer_color'); ?>;
			}				
			
		<?php }	
		if($this->config->get('pollishop_footertext_color')!='') { ?>
			#footer {
				color: <?php echo $this->config->get('pollishop_footertext_color'); ?>;
			}				
			
		<?php }				
		
		if($this->config->get('pollishop_alllink_color')!='') { ?>
			a, a b{
				color: <?php echo $this->config->get('pollishop_alllink_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_allactive_color')!='') { ?>
			a:hover, #currency a b, 
			.product-grid .name a:hover, .product-list .name a:hover,
			.product-list .wishlist a:hover, .product-list .compare a:hover 
			{
				color: <?php echo $this->config->get('pollishop_allactive_color'); ?>;
			}

			
		<?php }	
		
		if($this->config->get('pollishop_bigtitle_color')!='') { ?>
            ...
            .right_related .box-heading, .welcome{
				color: <?php echo $this->config->get('pollishop_bigtitle_color'); ?>;
			}				
			
		<?php }	

		if($this->config->get('pollishop_borderactiv_color')!='') { ?>
			.product-grid > div:hover, #slider_horiz .overview li > div:hover, 
			.slides .flex-active-slide p img, .slides p img:hover{
				border-color: <?php echo $this->config->get('pollishop_borderactiv_color'); ?>;
			}	
			.pagination .links b{ background-color:<?php echo $this->config->get('pollishop_borderactiv_color'); ?>;}			
			
		<?php }	
		
		if($this->config->get('pollishop_titleitem_color')!='') { ?>
			...
			.newslider-vertical .sliderkit-news h3 a, .bycategory #slider_vert .name a{
				color: <?php echo $this->config->get('pollishop_titleitem_color'); ?>;
			}				
			
		<?php }
				if($this->config->get('pollishop_titleitemdark_color')!='') { ?>
			#slider_vert .name a{
				color: <?php echo $this->config->get('pollishop_titleitemdark_color'); ?>;
			}				
			
		<?php }
		
		if($this->config->get('pollishop_btext_color')!='') { ?>
			body, .breadcrumb a{
				color: <?php echo $this->config->get('pollishop_btext_color'); ?>;
			}				
			
		<?php }
		
		if($this->config->get('pollishop_allprice_color')!='') { ?>
			...
			.product-info .price, .bycategory #slider_vert .price{
				color: <?php echo $this->config->get('pollishop_allprice_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_oprice_color')!='') { ?>
			...
			.product-list .price-old, .product-info .price-old, .bycategory #slider_vert .price-old  {
				color: <?php echo $this->config->get('pollishop_oprice_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_nprice_color')!='') { ?>
			...
			.product-list .price-new, .product-info .price-new , .bycategory #slider_vert .price-new {
				color: <?php echo $this->config->get('pollishop_nprice_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_allprice2_color')!='') { ?>
			#slider_vert .price{
				color: <?php echo $this->config->get('pollishop_allprice2_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_oprice2_color')!='') { ?>
			#slider_vert .price-old {
				color: <?php echo $this->config->get('pollishop_oprice2_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_nprice2_color')!='') { ?>
			#slider_vert .price-new {
				color: <?php echo $this->config->get('pollishop_nprice2_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_button1_top_color')!='') { ?>
			 .cart input.button, #button-cart, .product-info #button-cart{
				background-color: <?php echo $this->config->get('pollishop_button1_top_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_button1_bottom_color')!='') { ?>
			 .cart input.button:hover, #button-cart:hover, .product-info #button-cart:hover,
			 #header .button-search:hover{
				background-color: <?php echo $this->config->get('pollishop_button1_bottom_color'); ?>;
			}				
			
		<?php }
		
		if($this->config->get('pollishop_button1_text_color')!='') { ?>
			 .cart input.button, #button-cart, .product-info #button-cart,
			  .cart input.button:hover, #button-cart:hover, .product-info #button-cart:hover{
				color: <?php echo $this->config->get('pollishop_button1_text_color'); ?>;
			}				
			
		<?php }	
		
		
		if($this->config->get('pollishop_button2_top_color')!='') { ?>
			 a.button, input.button{
				background-color: <?php echo $this->config->get('pollishop_button2_top_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_bn2_bm_color')!='') { ?>
			 a.button:hover, input.button:hover{
				background-color: <?php echo $this->config->get('pollishop_bn2_bm_color'); ?>;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_button2_text_color')!='') { ?>
			 a.button, input.button, a.button:hover, input.button:hover{
				color: <?php echo $this->config->get('pollishop_button2_text_color'); ?>;
			}				
			
		<?php }	
		if($this->config->get('pollishop_wishlist_top_color')!='') { ?>
			.product-grid .wishlist a, #slider_horiz .wishlist a, .product-info a.wishlist1{
				background-color: <?php echo $this->config->get('pollishop_wishlist_top_color'); ?>;
			}
		<?php }		
			
		if($this->config->get('pollishop_wishlist_bottom_color')!='') { ?>
			.product-grid .wishlist a:hover, #slider_horiz .wishlist a:hover, .product-info a.wishlist1:hover{
				background-color: <?php echo $this->config->get('pollishop_wishlist_bottom_color'); ?>;
			}				
			
		<?php }
		if($this->config->get('pollishop_compare_top_color')!='') { ?>
			.product-grid .compare a, #slider_horiz .compare a, .product-info a.compare1{
				background-color: <?php echo $this->config->get('pollishop_compare_top_color'); ?>;
			}
		<?php }		
			
		if($this->config->get('pollishop_compare_bottom_color')!='') { ?>
			.product-grid .compare a:hover, #slider_horiz .compare a:hover, .product-info a.compare1:hover{
				background-color: <?php echo $this->config->get('pollishop_compare_bottom_color'); ?>;
			}				
			
		<?php }								
			
		
		if ($this->config->get('pollishop_body_font') != '' ) {
			$fontpre =  $this->config->get('pollishop_body_font');
		...
		<?php } 
			if($this->config->get('pollishop_title_font')!='') {
			$fontpre =  $this->config->get('pollishop_title_font');
			$font = str_replace("+", " ", $fontpre);
		?>
		...
		if($this->config->get('pollishop_headersize')!='') { ?>
			 h1, .product-info .price, .welcome{
				font-size: <?php echo $this->config->get('pollishop_headersize'); ?>px;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_header2size')!='') { ?>
			#slider_horiz .box-heading, .popularbox .box-heading, 
            .box .box-heading, #slider_vert .box-heading,
            .right_related .box-heading {
				font-size: <?php echo $this->config->get('pollishop_header2size'); ?>px;
			}				
			
		<?php }	
		if($this->config->get('pollishop_headersize3')!='') { ?>
			...
			#slider_vert .name a, #slider_horiz .name a, .bycategory #slider_vert .name a{
				font-size: <?php echo $this->config->get('pollishop_headersize3'); ?>px;
			}				
			
		<?php }	
		if($this->config->get('pollishop_bodysize')!='') { ?>
			body, td, th, input, textarea, select, a, #header #search input,
			#button-cart, .product-info .price .reward, .product-info .price .discount{
				font-size: <?php echo $this->config->get('pollishop_bodysize'); ?>px;
			}				
			
		<?php }	
		if($this->config->get('pollishop_pricesize')!='') { ?>
			...
			#slider_vert .price, .product-list .price, .bycategory #slider_vert .price {
				font-size: <?php echo $this->config->get('pollishop_pricesize'); ?>px;
			}				
			
		<?php }	
		
		if($this->config->get('pollishop_toplinksize')!='') { ?>
			#wrapper_menu .menu  li.fullwidth > a, #wrapper_menu .menu  .col_1 > div a, #wrapper_menu .menu  .col_1 > div   {
				font-size: <?php echo $this->config->get('pollishop_toplinksize'); ?>px;
			}				
			
		<?php }		
		
		if($this->config->get('pollishop_categorysize')!='') { ?>
			.box-category > ul > li > a, .box-content > ul > li > a  {
				font-size: <?php echo $this->config->get('pollishop_categorysize'); ?>px;
			}				
			
		<?php }	
		
				if($this->config->get('pollishop_home_enable')== 0) { ?>
		.multicolor1{ display:none;}
		<?php }	
		
		if($this->config->get('pollishop_account_enable')== 0) { ?>
		.multicolor2{ display:none;}
		<?php }
		
		if($this->config->get('pollishop_contact_enable')== 0) { ?>
		.multicolor3{ display:none;}
		<?php }
		
		if($this->config->get('pollishop_brand_enable')== 0) { ?>
...
<?php echo $google_analytics; ?>
			...
			<style>
				...
				.image-additional .youtube span {background-image: url(/catalog/view/theme/pollishop/image/play.png);background-repeat: no-repeat;width: 100%;height: 100%;position: absolute;z-index: 10;background-size: 50px;background-position: 50%;opacity: 0.8;-moz-transition: all ease 0.3s;-webkit-transition: all ease-in-out 0.3s;transition: all ease-in-out 0.3s;-o-transition: all ease 0.3s;-MS-transition: all ease 0.3s;}
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-5NZ7D6"
