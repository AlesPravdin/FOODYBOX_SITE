...
class ControllerPaymentWebPay extends Controller {
	...
	$this->document->setTitle = $this->language->get('heading_title');
		...
		$this->data['webpay_version'] = '1.5.4';
...
$this->data['text_test_yes'] = $this->language->get('text_test_yes');
$this->data['text_test_no'] = $this->language->get('text_test_no');
		...
		if (isset($this->request->post['webpay_test'])) {
			$this->data['webpay_test'] = (int)$this->request->post['webpay_test'];
		} elseif( $this->config->get('webpay_test') ) {
			$this->data['webpay_test'] = (int)$this->config->get('webpay_test');
		} else {
			$this->data['webpay_test'] = 0;
		}
